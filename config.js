...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || 263717234850-1632403322@g.us',
    ...
    RG: process.env.RG || 263717234850-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/GIMD8558mYuHsZp21EYPCr',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,263,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Raganork",
    BOT_NAME: process.env.BOT_NAME || 'Exton mods @youngjoshy2.0 ',
